  ...
  return (
    <div name='about' className='w-full h-full bg-gradient-to-b from-gray-800 to-black text-white'>
        <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center '>
            ...
            <p className='text-gray-300 text-lg'>Here is a little personal information about me. I grew up and live in the Pacific Northwest with my wife and daughter. I enjoy running, biking, reading, and gaming. I have a growing playing card collection. My biggest passion is learning. I spend months delving into topics that have piqued my interest.</p>
